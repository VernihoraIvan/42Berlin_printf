...
<ol>
  ...
  <pre><code>git clone https://github.com/VernihoraIvan/42Berlin_printf.git</code></pre>
...
<p>For more information about the project, read the [description](* https://linux.die.net/man/3/printf).</p>
